...
Відкрийте команду `LinkAI: Відкрити статистику` або панель LinkAI в Activity Bar. Оберіть мову та період, перегляньте метрики й натисніть **Перевірити** для AI-оцінки.
...
This is the README for your extension "linkai". After writing up a brief description, we recommend including the following sections.
